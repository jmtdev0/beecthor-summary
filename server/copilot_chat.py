...
def private_chat():
    ...
    <div class="shell private-shell">
      <div class="private-header"><div><h1 class="private-title">Chat</h1><div class="section-subtitle">Codex CLI persistente en el servidor.</div></div><div class="nav"><a href="/">Pública</a><a href="/private/polymarket">Polymarket</a><a href="/private/logs">Logs</a><a href="/private/chat" style="font-weight:700;color:#fff">Chat</a><a href="/logout">Logout</a></div></div>
...
def private_chat_display():
    ...
    return Response('VS Code display preview is disabled; chat now uses Codex CLI.', status=410, mimetype='text/plain', headers=headers)
