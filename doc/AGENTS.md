...
- after a successful approved run, update `last_video_id.txt`, `analyses_log.json`, `transcripts/`, and `doc/CHANGELOG.md`
...
- `doc/bets_real.md` tracks real positions.
- `doc/bets_simulation.md` tracks simulated positions.
- `analyses_log.json` is the source of yesterday-versus-today price comparisons.
- `doc/CHANGELOG.md` should record only notable progress, grouped by date.
