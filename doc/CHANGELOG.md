...
* El `Perps Tip` recibe ahora el precio actual de BTC como contexto y debe responder qué toca hacer hoy desde ese precio: abrir/mantener long o short, esperar una zona concreta, o quedarse fuera si no hay trade claro.
...
* Retirado el `account-equity gate`: cash/equity frente al bankroll inicial queda como métrica informativa y ya no puede bloquear entradas ni bajar la confianza salvo por límites mecánicos de stake/slots.
